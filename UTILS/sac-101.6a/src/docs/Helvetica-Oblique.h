#define Helvetica_Italic_Name           "Helvetica_Italic" 
#define Helvetica_Italic_Ascent          718 
#define Helvetica_Italic_Descent        -207 
#define Helvetica_Italic_Average_Width   556 
FontMetricsWidths Helvetica_Italic_Widths[] = {
         {   32,  278, "space" }, 
         {   33,  278, "exclam" }, 
         {   34,  355, "quotedbl" }, 
         {   35,  556, "numbersign" }, 
