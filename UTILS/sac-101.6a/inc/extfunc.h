 ...
 *                                                                         
 * int extfunc(argc, argv, call_data, update)                             
 * int argc;                                                               
 * char **argv;                                                            
 * sac_files *call_data;                                                   
 * int      *update;                                                      
...
typedef struct {
  ...
  float     **ext_yvalues;   /* 2-d array of y values, there are nfiles */
                             ...
                             /* long.  So, the vectors may not all be   */
                             /* the same length.                        */
...
static char *long_hdr_fields[MNHDR] = {  "nzyear"  , "nzjday"  , "nzhour"  , "nzmin" , "nzsec"   ,
                                         "nzmsec"  , "nvhdr"   , "norid"   , "nevid" , "npts"    ,
                                         "nsnpts"  , "nwfid"   , "nxsize"  , "nysize", "nhdr15"
};
#endif

#ifdef SAC_ENUM_NAME_FIELDS
...
#ifdef SAC_LOG_NAME_FIELDS
/* logical header fields */
static char *log_hdr_fields[MLHDR] =  {  "leven"   , "lpspol"  , "lovrok"  , "lcalda", "lhdr5"    };
#endif

#ifdef SAC_CHAR_NAME_FIELDS
/* character header fields */
/* note:  "kevnm" is 17 characters long. All other fields are eight chars long. */
...
#define IHGLP  35  /* High-gain long-period       */
#define ISRO   36  /* SRO                         */
...
#define IMB    52  /* Bodywave Magnitude */ /* These 18 added to describe */
...
#define IPDEQ  59  /* IPDEQ */
#define IPDEW  60  /* IPDEW */
#define IPDE   61  /* IPDE */
#define IISC   62  /* IISC */
#define IREB   63  /* IREB */
...
#define IQB	72/* Quarry or mine blast confirmed by quarry */
...
void        updatedfl   (sac_files  call_data, 
			 int        update, 
			 int       *nerr);
